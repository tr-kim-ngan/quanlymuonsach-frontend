        ...
        async updateProfile() {
            try {
                ...
                console.log("Dữ liệu chuẩn bị gửi:", {
                    HoLot: this.HoLot,
                    Ten: this.Ten,
                    NgaySinh: moment(this.NgaySinh, "YYYY-MM-DD").format('YYYY-MM-DD'),
                    Phai: this.Phai,
                    DiaChi: this.DiaChi,
                ...
                const response = await axios.put(`http://localhost:3000/api/docgia/${userId}`, {
                    HoLot: this.HoLot,
                    Ten: this.Ten,
                    NgaySinh: moment(this.NgaySinh, "YYYY-MM-DD").toISOString(), // Chuyển sang dạng ISO để server dễ xử lý
                    Phai: this.Phai,
                    DiaChi: this.DiaChi,
                    DienThoai: this.DienThoai
                });
